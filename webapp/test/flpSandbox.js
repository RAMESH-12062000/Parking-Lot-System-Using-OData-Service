		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comappparkinglotodatasys-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappparkinglotodatasys-display": {
								"semanticObject": "comappparkinglotodatasys",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.parkinglotodatasys",
									"url": sap.ui.require.toUrl("com/app/parkinglotodatasys")
								}
							}
						}
					}
